...
import com.example.shopify.adapter.ItemListAdapter;
...
public class ItemFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState)
    {
        ItemListRvBinding binding = DataBindingUtil.inflate(
                inflater, R.layout.item_list_rv, container, false);
        ...
        binding.rvItemList.setAdapter(new ItemListAdapter(listItem, getContext()));
